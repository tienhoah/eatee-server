  ...
  return knex('coupon_details').del()
    .then(function () {
      ...
      return knex('coupon_details').insert([
        ...
        {is_active: false, is_redeemed: true, swipe: true, coupon_batch_id: 2, user_id: 6 },
        ...
        {is_active: true, is_redeemed: true, swipe: true, coupon_batch_id: 4, user_id: 1 },
        ...
        {is_active: false, is_redeemed: true, swipe: true, coupon_batch_id: 4, user_id: 7 },
